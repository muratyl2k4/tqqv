var pins_config = {
  ...
  {
    "shape": "circle",
    "hover": "<b><u>İZMIR</u></b><br><span style='color: #999;'>Click to open a modal window!</span><br><span style='color: #ff6666;'><b>Modal Window Option is Compatible<br> with Bootstrap Only.</b></span>",
    "pos_X": 62,
    "pos_Y": 195,
    "size": 14,
    "outline": "#660000",
  ...
  {
    "shape": "circle",
    "hover": "<b><u>BURSA</u></b><br><span style='color: #999;'>*Click to open a webpage*</span>",
    "pos_X": 136,
    "pos_Y": 109,
    "size": 12,
    "outline": "#660000",
...
jQuery(function () {
  ...
  if(pins_len > 0) {
    ...
    var tsvg_obj = document.getElementById("trjspins");
    ...
    for (var i = 0; i < pins_len; i++) {
      if (pins_config.pins[i].shape === "circle") {
        ...
        svg_circle.setAttributeNS(null, "id", "trjspins_" + i);
        tsvg_obj.appendChild(svg_circle);
        trjsAddEvent(i);
      }
        ...
        svg_rect.setAttributeNS(null, "id", "trjspins_" + i);
        tsvg_obj.appendChild(svg_rect);
        trjsAddEvent(i);
      }
    }
...
function trjsAddEvent(id) {
  var obj = jQuery("#trjspins_" + id);
  if(pins_config.pins[id].active === true){
    obj.attr({"cursor": "pointer"});
    obj.hover(function () {
      jQuery("#trjstip").show().html(pins_config.pins[id].hover);
